export default function Contact() {
  return (
    <section id="contact">
      <div className="contact-eyebrow reveal">Let&apos;s build something</div>
      <h2 className="contact-headline reveal">GET IN<br />TOUCH</h2>
      <a href="mailto:christophermathai123@gmail.com" className="contact-email reveal">
